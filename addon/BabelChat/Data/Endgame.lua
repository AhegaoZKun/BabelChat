...
addonTable.EndgameDict = {
    ...
    ["chest"] = {
        enUS = "Chest (end-of-run reward)",
        esES = "Cofre (recompensa de M+)", esMX = "Cofre (recompensa de M+)",
        deDE = "Truhe (M+-Belohnung)", frFR = "Coffre (récompense M+)", itIT = "Scrigno (ricompensa M+)",
        ptBR = "Baú (recompensa de M+)", ruRU = "Сундук (награда за подземелье)",
        koKR = "상자(쐐기 보상)", zhCN = "宝箱（大秘境奖励）", zhTW = "寶箱（大秘境獎勵）",
        plPL = "Skrzynia (nagroda z M+)", svSE = "Kista (M+-belöning)", noNO = "Kiste (M+-belønning)",
    },
    ["timed"] = {
        enUS = "Timed (keystone beat the timer)",
        esES = "En tiempo (llave superada)", esMX = "En tiempo (llave superada)",
        deDE = "In der Zeit geschafft", frFR = "Dans les temps", itIT = "Nel tempo",
        ptBR = "No tempo", ruRU = "Уложились во время (ключ в тайм)",
        koKR = "시간 내 완료", zhCN = "限时内完成", zhTW = "限時內完成",
        plPL = "W czasie (klucz zaliczony)", svSE = "Klarad i tid", noNO = "Klart innen tiden",
    },
    ["depleted"] = {
        enUS = "Depleted (keystone missed the timer)",
        esES = "Agotada (llave sin tiempo)", esMX = "Agotada (llave sin tiempo)",
        deDE = "Aufgebraucht (nicht in der Zeit)", frFR = "Épuisée (hors des temps)", itIT = "Esaurita (fuori tempo)",
        ptBR = "Esgotada (fora do tempo)", ruRU = "Ключ слит (не уложились во время)",
        koKR = "소진된 쐐기돌(시간 초과)", zhCN = "钥石已耗尽（超时）", zhTW = "鑰石已耗盡（超時）",
        plPL = "Zużyty klucz (poza czasem)", svSE = "Depleted (nyckel utan tid)", noNO = "Depleted (nøkkel uten tid)",
    },
    ["upgrade"] = {
        enUS = "Upgrade (raise item level)",
        esES = "Mejora (subir nivel de objeto)", esMX = "Mejora (subir nivel de objeto)",
        deDE = "Aufwertung (Gegenstandsstufe)", frFR = "Amélioration (niveau d'objet)", itIT = "Potenziamento (livello oggetto)",
        ptBR = "Melhoria (nível de item)", ruRU = "Улучшение предмета",
        koKR = "업그레이드(아이템 레벨 상승)", zhCN = "升级装备（提升物品等级）", zhTW = "升級裝備（提升物品等級）",
        plPL = "Ulepszenie (poziom przedmiotu)", svSE = "Uppgradering (föremålsnivå)", noNO = "Oppgradering (gjenstandsnivå)",
    },
}
